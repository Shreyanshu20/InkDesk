...
const ReviewForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    // Updated validation - only check comment since title is removed
    ...
    if (result.success) {
      if (!existingReview) {
        // Reset form - removed title from reset
  ...
  return (
    <form
      ...
      className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-600"
    >
      ...
      {/* Comment - Now the main content field */}
      <div className="mb-6">
        <label
          htmlFor="comment"
        ...
        <textarea
          ...
          rows="6"
          className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary bg-white dark:bg-gray-700 text-gray-900 dark:text-white resize-vertical"
          maxLength={1000}
          required
        />
