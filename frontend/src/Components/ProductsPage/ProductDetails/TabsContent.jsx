      ...
      <div className="p-4 md:p-6 lg:p-8">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          {product.specifications && product.specifications.length > 0 && (
            <div>
              <h4 className="text-base md:text-lg font-semibold mb-3 md:mb-4 text-text">
                Key Features:
              </h4>
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 md:gap-6">
              <div className="flex items-center gap-4 md:gap-8">
                ...
                <div>
                  <div className="text-base md:text-xl font-bold text-text mb-1">
                    {reviewData.summary.totalReviews} Review
                    {reviewData.summary.totalReviews !== 1 ? "s" : ""}
                  </div>
                  <div className="text-xs md:text-sm text-gray-500 dark:text-gray-400">
                    {reviewData.summary.recommendationPercentage}% recommend
                    this product
                  </div>
                </div>
              </div>
              {reviewData.summary.mostRecentDate && (
                <div className="text-right text-xs md:text-sm text-gray-500 dark:text-gray-400">
                  <div>
                    Most Recent: {formatDate(reviewData.summary.mostRecentDate)}
                  </div>
                </div>
              )}
            </div>
            ...
            {reviewData.pagination.totalPages > 1 && (
              <div className="flex justify-center items-center gap-3 md:gap-4 mt-6 md:mt-8">
                ...
                <Button
                  onClick={() =>
                    setCurrentPage((prev) =>
                      Math.min(reviewData.pagination.totalPages, prev + 1)
                    )
                  }
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 md:p-6 rounded-xl border border-blue-200 dark:border-blue-700">
            <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
              ...
              <h4 className="text-sm md:text-base font-bold text-blue-900 dark:text-blue-300">
                Free Shipping
              </h4>
            </div>
            <p className="text-xs md:text-sm text-blue-800 dark:text-blue-300">
              On orders over ₹499. Delivery in 5-7 business days.
            </p>
          </div>
          <div className="bg-green-50 dark:bg-green-900/20 p-4 md:p-6 rounded-xl border border-green-200 dark:border-green-700">
            <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
              ...
              <h4 className="text-sm md:text-base font-bold text-green-900 dark:text-green-300">
                Express Delivery
              </h4>
            </div>
            <p className="text-xs md:text-sm text-green-800 dark:text-green-300">
              Get your order in 2-3 business days for ₹999.
            </p>
          </div>
          <div className="bg-gray-100 dark:bg-gray-800 p-4 md:p-6 rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3 md:gap-4 mb-2 md:mb-3">
              ...
              <h4 className="text-sm md:text-base font-bold text-text">
                Easy Returns
              </h4>
            </div>
            <p className="text-xs md:text-sm text-text/80">
              10-day return policy. Free return shipping.
            </p>
          </div>
        </div>
      </div>
